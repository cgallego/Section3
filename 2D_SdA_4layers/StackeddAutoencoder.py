...
class SdA(object):
    ...
    def build_finetune_functions(self, datasets, batch_size, learning_rate):
        ...
        train_set_x = theano.shared(np.asarray(np_train_set_x[:,:,3],dtype=theano.config.floatX),borrow=True)
        valid_set_x = theano.shared(np.asarray(np_valid_set_x[:,:,3],dtype=theano.config.floatX),borrow=True)
        test_set_x = theano.shared(np.asarray(np_test_set_x[:,:,3],dtype=theano.config.floatX),borrow=True)
