...
def SdA_gridsearch():
    ...
    ############
    nlayers = [1,2,3]
    nhiddens = [400,625,900,1600,2500]
    hidden_layers_sidelen = [20,25,30,40,50]
    ...
    for item in itertools.product(nlayers, nhiddens, nnoise_rate, nalpha): 
        ...
        sDA.pre_train(Xtrain, noise_rate=noiseRate, epochs=10)
       ...
       # W = sDA.Layers[0].W.T[:, 1:]
        ...
        sDA.finalLayer(Xtrain, ytrain, epochs=5)
