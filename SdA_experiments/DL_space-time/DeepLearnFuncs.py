...
class DeepLearnFuncs(object):
    ...
    def load_data(self, traindata_path, labeldata_path):
        ...
        #############
        # LOAD DATA 
        # eg. traindata_path='Z://Cristina//Section3//DeepLearning//allLpatches.pklz'
        # eg. labeldata_path='Z://Cristina//Section3//DeepLearning//allLabels.pklz'
        #############
        ...
        print 'Number of patches: %i train, %i valid, %i test' % (len(traindata),len(validdata),len(testdata))
        # plot train
    ...
    def sgd_optimization(self, learning_rate, n_epochs, batch_size):
        ...
        classifier = LogisticRegression(input=x, n_in=3600, n_out=6)
