"""
 Denoising auto-encoders (dA) using Theano.
 ...
 z \in [0,1]^d in input space z = g_{\theta'}(y) = s(W'y + b').  
...
class dA(object):
    ...
    def get_hidden_values(self, input):
        ...
        hidden1 = T.nnet.sigmoid(T.dot(input, self.W) + self.b)
    ...
    def get_cost_updates(self, corruption_level, learning_rate):
        ...
        L = (self.x - T.log(z)) * (self.x - T.log(z))
